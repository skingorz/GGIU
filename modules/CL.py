...
from architectures import get_classifier, get_backbone, PN_head, PN_TTA_head
import torch
...
class NoAV_CL(BaseFewShotModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # self.trainclassifer = PN_head(metric, scale_cls, normalize=normalize)
    ...
    def train_forward(self, batch, batch_size, way, shot):
        ...
        # logits_PN = self.trainclassifer(data_query, data_support, way, shot)
